...
L:SetOptionLocalization({
	PhaseTwoTimer	= "Show timer for Phase 2",
	PhaseTwoSoonWarning = "Show warning for when Phase 2 is about to begin",
	AddsSoonWarning	= "Show warning for when Guardians of Icecrown are about to spawn",
...
L:SetWarningLocalization({
	PhaseTwoSoonWarning = "Phase 2 begins soon!",
	AddsSoonWarning     = "Guardians of Icecrown incoming soon!",
})

L:SetTimerLocalization({
	PhaseTwoTimer	= "Time until Phase 2",
})
